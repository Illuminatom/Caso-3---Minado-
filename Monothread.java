...
public class Monothread extends Thread {
    ...
    public Monothread(int cantidadCerosP, String mensajePlanoP, MessageDigest algoritmoP, String repBinariaP) {
    ...
    @Override
    public void run() {
        System.out.println("Ejecutando Monothread");
